...
namespace Dandy.Linux.Udev
{
    ...
    public sealed class Context : IDisposable
    {
        ...
        static extern void udev_set_userdata(IntPtr udev, IntPtr userdata);
        ...
        [DllImport(UdevLibraryName)]
        static extern IntPtr udev_get_userdata(IntPtr udev);
        ...
        internal static Context GetInstance(IntPtr udev)
        {
            ...
            if (gcHandle.IsAllocated) {
                if (gcHandle.Target is Context context && context.handle != IntPtr.Zero) {
                    return context;
                }
                gcHandle.Free();
            }
