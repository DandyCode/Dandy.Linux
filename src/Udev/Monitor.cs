...
using static Dandy.Linux.Udev.Global;

namespace Dandy.Linux.Udev
{
    /// <summary>
    ...
    public sealed class Monitor : IDisposable
    {
        ...
        Monitor(IntPtr handle)
        {
            this.handle = handle;
        }

        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi, SetLastError = true)]
        static extern IntPtr udev_monitor_new_from_netlink(IntPtr udev, string name);

        static IntPtr New(Context udev, string name)
        {
            if (udev == null) {
        ...
        static extern IntPtr udev_monitor_unref(IntPtr udev_monitor);
        ...
        [DllImport(UdevLibraryName)]
        static extern int udev_monitor_filter_update(IntPtr udev_monitor);
        ...
        [DllImport(UdevLibraryName)]
        static extern int udev_monitor_enable_receiving(IntPtr udev_monitor);
        ...
        [DllImport(UdevLibraryName)]
        static extern int udev_monitor_set_receive_buffer_size(IntPtr udev_monitor, int size);
        ...
        [DllImport(UdevLibraryName)]
        static extern IntPtr udev_monitor_get_udev(IntPtr udev_monitor);
        ...
        [DllImport(UdevLibraryName)]
        static extern int udev_monitor_get_fd(IntPtr udev_monitor);
        ...
        static extern IntPtr udev_monitor_receive_device(IntPtr udev_monitor);
        ...
        static extern int udev_monitor_filter_add_match_subsystem_devtype(IntPtr udev_monitor, string subsystem, string devtype);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi)]
        static extern int udev_monitor_filter_add_match_tag(IntPtr udev_monitor, string tag);
        ...
        [DllImport(UdevLibraryName)]
        static extern int udev_monitor_filter_remove(IntPtr udev_monitor);
