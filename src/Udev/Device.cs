...
namespace Dandy.Linux.Udev
{
    ...
    public sealed class Device : IDisposable
    {
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi, SetLastError = true)]
        static extern IntPtr udev_device_get_parent_with_subsystem_devtype(IntPtr udev_device, string subsystem, string devtype);
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi, SetLastError = true)]
        static extern IntPtr udev_device_get_sysattr_value(IntPtr udev_device, string sysattr);
        ...
        public bool IsInitialized {
            get {
                return udev_device_get_is_initialized(Handle);
            }
        }
        ...
        [DllImport(UdevLibraryName, CharSet = CharSet.Ansi, SetLastError = true)]
        static extern IntPtr udev_device_new_from_subsystem_sysname(IntPtr udev_device, string subsystem, string sysname);
